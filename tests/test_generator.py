...
if __name__ == '__main__':
    ...
    # rule_file = './lambda_cps/rules/RoboGrammar.dot'
    new_parser = Parser(rule_file)
    rule_dict = new_parser.get_rule_dict()
    new_generator = DesignGenerator(rule_dict)
    init_graph, init_rule_list = new_parser.get_empty_sketch(None)
    ...
    new_generator.get_a_new_design_with_max_steps(init_graph, 10, 'pydot')